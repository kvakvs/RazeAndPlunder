...
namespace BWTA {
  ...
  void load_data(std::string filename) {
    ...
    for (int x = 0; x < map_width; x++) {
      for (int y = 0; y < map_height; y++) {
        ...
        file_in >> rid;
        if (rid == -1)
          BWTA_Result::getRegion[x][y] = nullptr;
        else
    ...
    for (int x = 0; x < map_width; x++) {
      for (int y = 0; y < map_height; y++) {
        ...
        file_in >> cid;
        if (cid == -1)
          BWTA_Result::getChokepoint[x][y] = nullptr;
        else
    ...
    for (int x = 0; x < map_width; x++) {
      for (int y = 0; y < map_height; y++) {
        ...
        file_in >> bid;
        if (bid == -1)
          BWTA_Result::getBaseLocation[x][y] = nullptr;
        else
    ...
    for (int x = 0; x < map_width * 4; x++) {
      for (int y = 0; y < map_height * 4; y++) {
        ...
        file_in >> cid;
        if (cid == -1)
          BWTA_Result::getChokepointW[x][y] = nullptr;
        else
    ...
    for (int x = 0; x < map_width * 4; x++) {
      for (int y = 0; y < map_height * 4; y++) {
        ...
        file_in >> bid;
        if (bid == -1)
          BWTA_Result::getBaseLocationW[x][y] = nullptr;
        else
    ...
    for (int x = 0; x < map_width; x++) {
      for (int y = 0; y < map_height; y++) {
        ...
        file_in >> pid;
        if (pid == -1)
          BWTA_Result::getUnwalkablePolygon[x][y] = nullptr;
        else
  ...
  void save_data(std::string filename) {
    ...
    for (const auto& r : BWTA_Result::regions) {
      file_out << rid[r] << "\n";
      PolygonImpl poly = PolygonImpl(r->getPolygon());
      file_out << poly.size() << "\n";
    ...
    for (int x = 0; x < (int)BWTA_Result::getRegion.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getRegion.getHeight(); y++) {
        if (BWTA_Result::getRegion[x][y] == nullptr)
          file_out << "-1\n";
        else
    ...
    for (int x = 0; x < (int)BWTA_Result::getChokepoint.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getChokepoint.getHeight(); y++) {
        if (BWTA_Result::getChokepoint[x][y] == nullptr)
          file_out << "-1\n";
        else
    ...
    for (int x = 0; x < (int)BWTA_Result::getBaseLocation.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getBaseLocation.getHeight(); y++) {
        if (BWTA_Result::getBaseLocation[x][y] == nullptr)
          file_out << "-1\n";
        else
    ...
    for (int x = 0; x < (int)BWTA_Result::getChokepointW.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getChokepointW.getHeight(); y++) {
        if (BWTA_Result::getChokepointW[x][y] == nullptr)
          file_out << "-1\n";
        else
    ...
    for (int x = 0; x < (int)BWTA_Result::getBaseLocationW.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getBaseLocationW.getHeight(); y++) {
        if (BWTA_Result::getBaseLocationW[x][y] == nullptr)
          file_out << "-1\n";
        else
    ...
    for (int x = 0; x < (int)BWTA_Result::getRegion.getWidth(); x++) {
      for (int y = 0; y < (int)BWTA_Result::getRegion.getHeight(); y++) {
        if (BWTA_Result::getUnwalkablePolygon[x][y] == nullptr)
          file_out << "-1\n";
        else

...
namespace BWTA {
  ...
  public:
    ...
    const std::set<Chokepoint*>& getChokepoints() const override {
      return this->_chokepoints;
    };

    const std::set<BaseLocation*>& getBaseLocations() const override {
      return this->baseLocations;
    };

    const std::set<Region*>& getReachableRegions() const override {
      return this->reachableRegions;
    };

    const int getMaxDistance() const override {
      return this->_maxDistance;
    };

    const int getColorLabel() const override {
      return this->_color;
    };

    const double getHUE() const override {
      return this->_hue;
    };
    ...
    const BWAPI::Position& getOpennessPosition() const override {
      return this->_opennessPoint;
    };

    const double getOpennessDistance() const override {
      return this->_opennessDistance;
    };
